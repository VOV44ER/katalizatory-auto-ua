...
export async function POST(req: NextRequest) {
    ...
    // Заголовок без слов "источник" и "новая заявка"
    lines.push(`🚀 <b>KATALIZATORY AUTO UA</b>`);

    // Основные поля с иконками и жирными подписями
    ...
    // Блок з extra/додатковою інформацією вимкнений за побажанням —
    // при потребі можна знову розкоментувати і виводити окремо.
