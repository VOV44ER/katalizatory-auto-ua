      ...
      <div className="container mx-auto px-4 lg:px-8">
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Найчастіше люди здають каталізатори таких автомобільних брендів, як Audi, BMW, Hyundai,
            Kia, Volkswagen, Toyota. Ціни стартують від 70$ та можуть бути вище 1300$ — точну
            вартість визначаємо після спектрального аналізу стану каталізатора.
          </p>
        </div>
